...
const convert_hour_to_minutes_1 = require("./utils/convert-hour-to-minutes");
...
app.post('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ad = yield prisma.ad.create({
        data: {
            ...
            hourStart: (0, convert_hour_to_minutes_1.convertHourStringToMinutes)(body.hourStart),
            hourEnd: (0, convert_hour_to_minutes_1.convertHourStringToMinutes)(body.hourEnd),
